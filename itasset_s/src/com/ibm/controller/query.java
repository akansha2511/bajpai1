 ...
 */
	...
	Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/mvc","root","pass");
    ...
    public int update_data(String q1)
    {
        ...
        {
             Class.forName("com.mysql.jdbc.Driver").newInstance();    //driver for MySQL
	 conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/mvc","root","pass");
